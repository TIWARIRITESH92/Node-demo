...
var dbConfig = {
  user: config.postgres.username, //env var: PGUSER
  database: config.postgres.database, //env var: PGDATABASE
  password: config.postgres.password, //env var: PGPASSWORD
  host: config.postgres.url, // Server hosting the postgres database
...
pool.on('error', function (err, client) {
  ...
  console.log('Something went wrong with postgres connection'.red);
});
